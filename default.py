# -*- coding: utf-8 -*-
#------------------------------------------------------------
# http://www.youtube.com/user/CanalPlenitudTV
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "CanalPlenitudTV"

# Entry point
def run():
    plugintools.log("CanalPlenitudTV.run")
...
def main_list(params):
    plugintools.log("CanalPlenitudTV.main_list "+repr(params))
